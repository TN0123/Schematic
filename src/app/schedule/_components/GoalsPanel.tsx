...
export default function GoalsPanel() {
  ...
  return (
    <>
      <aside
        className="hidden md:flex fixed md:relative z-30 h-full w-80 bg-white dark:bg-dark-background border-r dark:border-dark-divider py-6 px-4 flex-col transition-all duration-300 items-center"
        id="goals-panel"
      >
